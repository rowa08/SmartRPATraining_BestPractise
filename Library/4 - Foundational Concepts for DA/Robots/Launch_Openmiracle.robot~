...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-types>
      <type name="Openmiracle_Login_Input"/>
    </referenced-types>
    <referenced-snippets>
      <snippet name="Openmiracle_Login"/>
    </referenced-snippets>
    <triggers/>
    <typed-variables/>
    <global-variables/>
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="3">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          ...
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">Openmiracle_Login_Input.username</property>
          </property>
        </property>
      ...
      <object class="Transition" serializationversion="3" id="4">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          ...
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">Openmiracle_Login_Input.password</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
      ...
      <object class="SnippetStep" id="5">
        ...
        <snippetName class="String">Openmiracle_Login</snippetName>
        <snippetStepComment>
          <null/>
        </snippetStepComment>
      </object>
